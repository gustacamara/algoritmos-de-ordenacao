...
export function TempoOrdenacao1000() {
  return (
    <Card className="grid grid-cols-2-col col-span-3 gap-4">
      <CardHeader>
        <CardTitle>Vetores de 1.000 linhas</CardTitle>
        <CardDescription>
          Comparativo com os vetores de <span className="text-accent-foreground">1.000</span> linhas.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[240px] w-full">
          <BarChart accessibilityLayer data={filtraSortPorTamanho(1000)}>
